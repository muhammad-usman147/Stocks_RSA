...
import pandas as pd 
import pypyodbc 
class tblBrokerTransConsole():
    def __init__(self):
        connection = pypyodbc.connect('Driver={SQL Server};Server=.;Database=MetalTiger')
        self.cursor = connection.cursor()

    
    def InsertDataBuld(self,sheet_name,filename = 'MTR Investments 07-11-2020 v1.xlsm'):
        """
        docstring
        """
        ...
        for i in range(df.shape[0]):
            ...
            insert ="INSERT INTO tblBrokerTransConsol(Date,Reference,Description,Code,Txtype,Nonsharetransacts,Shares,Pricelocalcurrency,Exchangerate,year,month,Broker) values('2016-01-01 00:00:00','nan','nan','AAU','b/fwd',4,4927777,0.8144443224602088,0.8144443224602088,2016,1,'usman')"
